...
import { FALLBACK_PLACEMENTS } from '../modules/Tooltip/constants/tooltip';
 ...
 * }
 */
export const useFloatingPlacement = (placementSide) => {
  const { refs, placement } = useFloating({
    placement: placementSide,
    middleware: [
      shift(),
      flip({
        fallbackPlacements: FALLBACK_PLACEMENTS[placementSide]
      })
    ],
