...
import { DropdownContextData } from "./context";
...
export const dropdownProps = {
   ...
   * @see DROPDOWN_ALIGN
   */
  align: PropTypes.oneOf(Object.values(DROPDOWN_ALIGN)),
  /**
   ...
   * @see DROPDOWN_SIDE
   */
  side: PropTypes.oneOf(Object.values(DROPDOWN_SIDE)),
