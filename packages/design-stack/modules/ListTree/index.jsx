...
const ListTree = forwardRef(
  (
    { children = null, id = null, indentationLevel = 1, isTreeOpen = false },
    ref
  ) => (
    <Disclosure
      as="div"
...
ListTree.propTypes = {
  /** The content to be rendered within the ListTree, typically `ListTreeItem` and nested `ListTree` components. */
  children: PropTypes.node,
  /** Optional unique identifier for the root `div` element of the component. */
  id: PropTypes.string,
  /** The nesting level of the tree, used to calculate indentation. A level greater than 1 adds left margin and padding. */
  indentationLevel: PropTypes.number,
  /** Controls the initial open/closed state of the tree. */
