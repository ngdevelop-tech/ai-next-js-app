...
import { PageHeadingsActions } from "./components/PageHeadingsActions";
import { PageHeadingsBreadcrumb } from "./components/PageHeadingsBreadcrumb";
import { PageHeadingsSubsection } from "./components/PageHeadingsSubsection";
import { PageHeadingsTabs } from "./components/PageHeadingsTabs";
import { PageHeadingsTitleAndBadge } from "./components/PageHeadingsTitleAndBadge";
...
const PageHeadings = ({
  ...
  <div
    className={twClassNames(
      "border-b border-neutral-default bg-neutral-default p-6",
      { "pb-0": tabsProps },
      wrapperClassName
    )}
    {...(id !== null && { id })}
  >
    <div className="lg:flex lg:items-center lg:justify-between">
      <div
        className={twClassNames("min-w-0 flex-1", {
          "flex flex-col gap-3": loading,
        })}
      >
        {/* breadcrumbs */}
        <PageHeadingsBreadcrumb
          loading={loading}
          breadcrumbNode={breadcrumbNode}
        />

        {/* title */}
        <PageHeadingsTitleAndBadge
          heading={heading}
          isEditable={isEditable}
          inlineEditingProps={inlineEditingProps}
          isTruncateTooltip={isTruncateTooltip}
          breadcrumbNode={breadcrumbNode}
          headerBadgesNode={headerBadgesNode}
          theme={theme}
          loading={loading}
        />

        <PageHeadingsSubsection loading={loading} subSection={subSection} />
      </div>
      <PageHeadingsActions loading={loading} actions={actions} />
    </div>
...
PageHeadings.propTypes = {
  ...
  tabsProps: PropTypes.shape({
    ...
    smallTabsTheme: PropTypes.string,
