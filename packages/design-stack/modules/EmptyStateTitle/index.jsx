/**
 * @typedef {Object} EmptyStateTitleProps
 ...
 * @property {string} wrapperClassName? - A custom CSS class name to style the EmptyStateTitle component.
 */
...
/**
 * @type {React.FC<EmptyStateTitleProps>}
 */
const EmptyStateTitle = ({
  ...
  <div
    className={twClassNames(
      "text-sm font-medium leading-5 text-neutral-default",
      {
...
EmptyStateTitle.propTypes = {
  ...
  /** A custom CSS class name to style the EmptyStateTitle component. */
